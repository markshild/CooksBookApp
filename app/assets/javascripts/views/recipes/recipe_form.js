CooksBookApp.Views.RecipeForm = Backbone.CompositeView.extend({
  ...
  addIngredient: function (event) {
    ...
    var newEl = $('<li class="group"><input type="text" name="ingredient[]" placeholder="ex: 2 cups flour"><span class="remove">X</span></li>');
    this.$('ul#ingredients').append(newEl);
  },

  addDirection: function (event) {
    event.preventDefault();
    var newEl = $('<li  class="group"><input type="text" name="direction[]" placeholder="New Direction"><span class="remove">X</span></li>');
